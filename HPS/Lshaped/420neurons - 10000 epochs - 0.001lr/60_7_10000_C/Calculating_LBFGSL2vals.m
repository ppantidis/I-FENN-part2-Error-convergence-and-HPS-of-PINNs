...
epochs  = [10000];   
runs    = 1:10;
Predictions_LshapedCoarse_60_7_10000_highlr       = zeros(16400,10);
Adam_Predictions_LshapedCoarse_60_7_10000_highlr  = zeros(16400,10);

LshapedCoarse_l2norm_60_7_10000_highlr        = zeros(length(runs),1);
LshapedCoarse_Adam_l2norm_60_7_10000_highlr   = zeros(length(runs),1);
    ...
    for j = 1:length(neurons)
        for k = 1:length(epochs)
            for l = 1:length(runs)
                ...
                Adam_Predictions_LshapedCoarse_60_7_10000_highlr(:,l) = current_file / 10;
                LshapedCoarse_Adam_l2norm_60_7_10000_highlr(l,1) = sqrt(sum((LshapedCoarse_enonlocal_true_vals - Adam_Predictions_LshapedCoarse_60_7_10000_highlr(:,l)).^2 ./ LshapedCoarse_enonlocal_true_vals.^2));
                clear current_file
                ...
                Predictions_LshapedCoarse_60_7_10000_highlr(:,l) = current_file / 10;
                LshapedCoarse_l2norm_60_7_10000_highlr(l,1) = sqrt(sum((LshapedCoarse_enonlocal_true_vals - Predictions_LshapedCoarse_60_7_10000_highlr(:,l)).^2 ./ LshapedCoarse_enonlocal_true_vals.^2));
                clear current_file
...
save Adam_Pred_L2norms_LshapedCoarse_60_7_10000_highlr LshapedCoarse_Adam_l2norm_60_7_10000_highlr
save LBFGS_Pred_L2norms_LshapedCoarse_60_7_10000_highlr LshapedCoarse_l2norm_60_7_10000_highlr
