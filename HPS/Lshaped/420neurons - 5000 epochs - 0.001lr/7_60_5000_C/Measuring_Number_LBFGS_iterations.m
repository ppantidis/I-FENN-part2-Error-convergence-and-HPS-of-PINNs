    ...
    for j = 1:length(neurons)
        for k = 1:length(epochs)
            for l = 1:length(runs)
                ...
                % Store cost values
                No_LBFGS_iters_LshapedCoare_7_60_5000_highlr(l,1) = length(current_file) - epochs;
...
save No_LBFGS_iters_LshapedCoare_7_60_5000_highlr No_LBFGS_iters_LshapedCoare_7_60_5000_highlr
