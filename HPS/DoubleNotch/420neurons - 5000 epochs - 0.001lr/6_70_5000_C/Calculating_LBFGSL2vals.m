...
epochs  = [5000];   
runs    = 1:10;
Predictions_DNCoare_6_70_5000_highlr       = zeros(7552,10);
Adam_Predictions_DNCoare_6_70_5000_highlr  = zeros(7552,10);

DNCoare_l2norm_6_70_5000_highlr        = zeros(length(runs),1);
DNCoare_Adam_l2norm_6_70_5000_highlr   = zeros(length(runs),1);
    ...
    for j = 1:length(neurons)
        for k = 1:length(epochs)
            for l = 1:length(runs)
                ...
                Adam_Predictions_DNCoare_6_70_5000_highlr(:,l) = current_file / 10;
                DNCoare_Adam_l2norm_6_70_5000_highlr(l,1) = sqrt(sum((DNCoare_enonlocal_true_vals - Adam_Predictions_DNCoare_6_70_5000_highlr(:,l)).^2 ./ DNCoare_enonlocal_true_vals.^2));
                clear current_file
                ...
                Predictions_DNCoare_6_70_5000_highlr(:,l) = current_file / 10;
                DNCoare_l2norm_6_70_5000_highlr(l,1) = sqrt(sum((DNCoare_enonlocal_true_vals - Predictions_DNCoare_6_70_5000_highlr(:,l)).^2 ./ DNCoare_enonlocal_true_vals.^2));
                clear current_file
...
save Adam_Pred_L2norms_DNCoare_6_70_5000_highlr DNCoare_Adam_l2norm_6_70_5000_highlr
save LBFGS_Pred_L2norms_DNCoare_6_70_5000_highlr DNCoare_l2norm_6_70_5000_highlr
