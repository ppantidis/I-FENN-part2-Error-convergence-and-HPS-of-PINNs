...
layers = [4, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 1]
epochs = 10000
hist_vec = []
    ...
    def train(self, nIter):
        ...
        for it in range(nIter):
            ...
            if it + 1 == epochs:
                ...
                print("it + 1: ", it + 1)
                np.savetxt("Model11_TestE_" + Modelmesh + "_Adam_Predictions_" + str(num_hidlayers) + "hidlay_" + str(num_hidlayer_neurons) + "units_" + str(epochs) + "ep_inc_140" + "_v"+ str(num_cases + 1) + ".txt", enonlocal_pred_star, fmt='%.18e', delimiter=' ', newline='\n', header='', footer='', comments='# ', encoding=None)
...
if __name__ == "__main__": 
    ...
    with tf.device('/device:GPU:0'):
        ...
        data     = pd.read_csv("data_GP_" + Modelmesh + "_Nonlocal_gradient_Analytical_inc_140.csv", usecols = column_list)         # pandas dataframe
        data_lrb = pd.read_csv("data_nodes_lrb_" + Modelmesh + "_Nonlocal_gradient_Analytical_inc_140.csv", usecols = column_list)  # pandas dataframe
        data_btb = pd.read_csv("data_nodes_btb_" + Modelmesh + "_Nonlocal_gradient_Analytical_inc_140.csv", usecols = column_list)  # pandas dataframe
        ...
        for num_cases in range(0, 10):
            ...
            if IsExistModel == 0:
               ...
               # Testcase: use the just trained network to make predictions and store results
                predictdata            = pd.read_csv("data_GP_" + Modelmesh + "_Nonlocal_gradient_Analytical_inc_140.csv", usecols = column_list)           # pandas dataframe
                predictdata_lrb        = pd.read_csv("data_nodes_lrb_" + Modelmesh + "_Nonlocal_gradient_Analytical_inc_140.csv", usecols = column_list)    # pandas dataframe
                predictdata_btb        = pd.read_csv("data_nodes_btb_" + Modelmesh + "_Nonlocal_gradient_Analytical_inc_140.csv", usecols = column_list)    # pandas dataframe
                ...
                np.savetxt("Model11_TestE_" + Modelmesh + "_Predictions_"               + str(num_hidlayers) + "hidlay_" + str(num_hidlayer_neurons) + "units_" + str(epochs) + "ep_inc_140" + "_v"+ str(num_cases + 1) + ".txt", enonlocal_pred_star, fmt='%.18e', delimiter=' ', newline='\n', header='', footer='', comments='# ', encoding=None)
                np.savetxt("Model11_TestE_" + Modelmesh + "_Predictions_derivatives_"   + str(num_hidlayers) + "hidlay_" + str(num_hidlayer_neurons) + "units_" + str(epochs) + "ep_inc_140" + "_v"+ str(num_cases + 1) + ".txt", enonlocal_pred_elocal_star, fmt='%.18e', delimiter=' ', newline='\n', header='', footer='', comments='# ', encoding=None)
                np.savetxt("Model11_TestE_" + Modelmesh + "_History_"                   + str(num_hidlayers) + "hidlay_" + str(num_hidlayer_neurons) + "units_" + str(epochs) + "ep_inc_140" + "_v"+ str(num_cases + 1) + ".txt", hist_vec, fmt='%.18e', delimiter=' ', newline='\n', header='', footer='', comments='# ', encoding=None)
                np.savetxt("Model11_TestE_" + Modelmesh + "_Weights_Change_"            + str(num_hidlayers) + "hidlay_" + str(num_hidlayer_neurons) + "units_" + str(epochs) + "ep_inc_140" + "_v"+ str(num_cases + 1) + ".txt", weights_change_list, fmt='%.18e', delimiter=' ', newline='\n', header='', footer='', comments='# ', encoding=None)
                ...
                testpredictdata             = pd.read_csv("data_GP_" + Modelmesh + "_Nonlocal_gradient_Analytical_inc_140.csv", usecols = column_list)         # pandas dataframe
                testpredictdata_lrb         = pd.read_csv("data_nodes_lrb_" + Modelmesh + "_Nonlocal_gradient_Analytical_inc_140.csv", usecols = column_list)  # pandas dataframe       
                testpredictdata_btb         = pd.read_csv("data_nodes_btb_" + Modelmesh + "_Nonlocal_gradient_Analytical_inc_140.csv", usecols = column_list)  # pandas dataframe       
