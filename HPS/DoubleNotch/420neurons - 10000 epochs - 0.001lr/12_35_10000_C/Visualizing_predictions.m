...
data_DNCoarse = table2array(readtable('data_GP_DoubleNotchCoarse_Nonlocal_gradient_Analytical_inc_140_init.csv'));
xcoord_vec = data_DNCoarse(:,1);
ycoord_vec = data_DNCoarse(:,2);
local_strain_vec = data_DNCoarse(:,11);
nonlocal_strain_vec_truth = data_DNCoarse(:,12);
clear data_DNCoarse

%%%%%%%%%%%%%%%%% Load data from Neural Network prediction %%%%%%%%%%%%%%%%
% Load and store the nonlocal strain prediction vector

J_Coarse_12_35_10000_M1 = load(strcat("Model11_TestE_DoubleNotchCoarse_Predictions_12hidlay_35units_10000ep_inc_140_v1.txt"));
J_Coarse_12_35_10000_M2 = load(strcat("Model11_TestE_DoubleNotchCoarse_Predictions_12hidlay_35units_10000ep_inc_140_v2.txt"));
J_Coarse_12_35_10000_M3 = load(strcat("Model11_TestE_DoubleNotchCoarse_Predictions_12hidlay_35units_10000ep_inc_140_v3.txt"));
J_Coarse_12_35_10000_M4 = load(strcat("Model11_TestE_DoubleNotchCoarse_Predictions_12hidlay_35units_10000ep_inc_140_v4.txt"));
J_Coarse_12_35_10000_M5 = load(strcat("Model11_TestE_DoubleNotchCoarse_Predictions_12hidlay_35units_10000ep_inc_140_v5.txt"));
J_Coarse_12_35_10000_M6 = load(strcat("Model11_TestE_DoubleNotchCoarse_Predictions_12hidlay_35units_10000ep_inc_140_v6.txt"));
J_Coarse_12_35_10000_M7 = load(strcat("Model11_TestE_DoubleNotchCoarse_Predictions_12hidlay_35units_10000ep_inc_140_v7.txt"));
J_Coarse_12_35_10000_M8 = load(strcat("Model11_TestE_DoubleNotchCoarse_Predictions_12hidlay_35units_10000ep_inc_140_v8.txt"));
J_Coarse_12_35_10000_M9 = load(strcat("Model11_TestE_DoubleNotchCoarse_Predictions_12hidlay_35units_10000ep_inc_140_v9.txt"));
