    ...
    for j = 1:length(neurons)
        for k = 1:length(epochs)
            for l = 1:length(runs)
                ...
                % Store cost values
                No_LBFGS_iters_StrC100_7_80_10000_lowlr(l,1) = length(current_file) - 10000;
...
save No_LBFGS_iters_StrC100_7_80_10000_lowlr No_LBFGS_iters_StrC100_7_80_10000_lowlr
