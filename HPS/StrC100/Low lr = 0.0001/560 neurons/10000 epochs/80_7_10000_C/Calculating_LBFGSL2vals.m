...
epochs  = [10000];   
runs    = 1:10;
Predictions_StrC100_80_7_10000_lowlr       = zeros(10000,10);
Adam_Predictions_StrC100_80_7_10000_lowlr  = zeros(10000,10);

StrC100_l2norm_80_7_10000_lowlr        = zeros(length(runs),1);
StrC100_Adam_l2norm_80_7_10000_lowlr   = zeros(length(runs),1);
    ...
    for j = 1:length(neurons)
        for k = 1:length(epochs)
            for l = 1:length(runs)
                ...
                Adam_Predictions_StrC100_80_7_10000_lowlr(:,l) = current_file / 10;
                StrC100_Adam_l2norm_80_7_10000_lowlr(l,1) = sqrt(sum((StrC100_enonlocal_true_vals - Adam_Predictions_StrC100_80_7_10000_lowlr(:,l)).^2 ./ StrC100_enonlocal_true_vals.^2));
                clear current_file
                ...
                Predictions_StrC100_80_7_10000_lowlr(:,l) = current_file / 10;
                StrC100_l2norm_80_7_10000_lowlr(l,1) = sqrt(sum((StrC100_enonlocal_true_vals - Predictions_StrC100_80_7_10000_lowlr(:,l)).^2 ./ StrC100_enonlocal_true_vals.^2));
                clear current_file
...
save Adam_Pred_L2norms_StrC100_80_7_10000_lowlr StrC100_Adam_l2norm_80_7_10000_lowlr
save LBFGS_Pred_L2norms_StrC100_80_7_10000_lowlr StrC100_l2norm_80_7_10000_lowlr
