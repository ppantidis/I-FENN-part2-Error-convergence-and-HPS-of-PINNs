...
J_Coarse_6_50_5000_M1 = load(strcat("Model11_TestE_StrC100_Predictions_6hidlay_50units_5000ep_inc_164_v1.txt"));
J_Coarse_6_50_5000_M2 = load(strcat("Model11_TestE_StrC100_Predictions_6hidlay_50units_5000ep_inc_164_v2.txt"));
J_Coarse_6_50_5000_M3 = load(strcat("Model11_TestE_StrC100_Predictions_6hidlay_50units_5000ep_inc_164_v3.txt"));
J_Coarse_6_50_5000_M4 = load(strcat("Model11_TestE_StrC100_Predictions_6hidlay_50units_5000ep_inc_164_v4.txt"));
J_Coarse_6_50_5000_M5 = load(strcat("Model11_TestE_StrC100_Predictions_6hidlay_50units_5000ep_inc_164_v5.txt"));
J_Coarse_6_50_5000_M6 = load(strcat("Model11_TestE_StrC100_Predictions_6hidlay_50units_5000ep_inc_164_v6.txt"));
J_Coarse_6_50_5000_M7 = load(strcat("Model11_TestE_StrC100_Predictions_6hidlay_50units_5000ep_inc_164_v7.txt"));
J_Coarse_6_50_5000_M8 = load(strcat("Model11_TestE_StrC100_Predictions_6hidlay_50units_5000ep_inc_164_v8.txt"));
J_Coarse_6_50_5000_M9 = load(strcat("Model11_TestE_StrC100_Predictions_6hidlay_50units_5000ep_inc_164_v9.txt"));

nonlocal_strain_vec_pred_M1 = J_Coarse_6_50_5000_M1 / 10;
nonlocal_strain_vec_pred_M2 = J_Coarse_6_50_5000_M2 / 10;
nonlocal_strain_vec_pred_M3 = J_Coarse_6_50_5000_M3 / 10;
nonlocal_strain_vec_pred_M4 = J_Coarse_6_50_5000_M4 / 10;
nonlocal_strain_vec_pred_M5 = J_Coarse_6_50_5000_M5 / 10;
nonlocal_strain_vec_pred_M6 = J_Coarse_6_50_5000_M6 / 10;
nonlocal_strain_vec_pred_M7 = J_Coarse_6_50_5000_M7 / 10;
nonlocal_strain_vec_pred_M8 = J_Coarse_6_50_5000_M8 / 10;
nonlocal_strain_vec_pred_M9 = J_Coarse_6_50_5000_M9 / 10;
...
title0 = title(t, '\bf{Non-local strain predictions (6x50 - 5000)}');
...
hold on;
t = tiledlayout(3,3,'TileSpacing','tight','Padding','compact');
title0 = title(t, '\bf{Non-local strain RSE (6x50 - 5000)}');
set(title0,'interpreter','latex','fontsize', 16,'Color','k');
