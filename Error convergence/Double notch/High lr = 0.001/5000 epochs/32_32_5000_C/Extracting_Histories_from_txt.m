    ...
    for j = 1:length(neurons)
        for k = 1:length(epochs)
            for l = 1:length(runs)
                ...
                % Store cost values
                J_DoubleNotchCoarse_32_32_5000_highlr(l,:) = [current_file(epochs(k)) current_file(end)];
            end        
        end
    end
end
...
save Histories_DoubleNotchCoarse_32_32_5000_highlr J_DoubleNotchCoarse_32_32_5000_highlr
