...
epochs  = [5000];   
runs    = 1:10;
Predictions_StrF100_12_12_5000_lowlr       = zeros(40000,10);
Adam_Predictions_StrF100_12_12_5000_lowlr  = zeros(40000,10);

StrF100_l2norm_12_12_5000_lowlr        = zeros(length(runs),1);
StrF100_Adam_l2norm_12_12_5000_lowlr   = zeros(length(runs),1);
    ...
    for j = 1:length(neurons)
        for k = 1:length(epochs)
            for l = 1:length(runs)
                ...
                Adam_Predictions_StrF100_12_12_5000_lowlr(:,l) = current_file / 10;
                StrF100_Adam_l2norm_12_12_5000_lowlr(l,1) = sqrt(sum((StrF100_enonlocal_true_vals - Adam_Predictions_StrF100_12_12_5000_lowlr(:,l)).^2 ./ StrF100_enonlocal_true_vals.^2));
                clear current_file
                ...
                Predictions_StrF100_12_12_5000_lowlr(:,l) = current_file / 10;
                StrF100_l2norm_12_12_5000_lowlr(l,1) = sqrt(sum((StrF100_enonlocal_true_vals - Predictions_StrF100_12_12_5000_lowlr(:,l)).^2 ./ StrF100_enonlocal_true_vals.^2));
                clear current_file
...
save Adam_Pred_L2norms_StrF100_12_12_5000_lowlr StrF100_Adam_l2norm_12_12_5000_lowlr
save LBFGS_Pred_L2norms_StrF100_12_12_5000_lowlr StrF100_l2norm_12_12_5000_lowlr
