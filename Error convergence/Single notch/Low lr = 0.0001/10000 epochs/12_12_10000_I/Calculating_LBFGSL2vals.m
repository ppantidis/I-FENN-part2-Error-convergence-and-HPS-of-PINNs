...
epochs  = [10000];   
runs    = 1:10;
Predictions_StrI100_12_12_10000_lowlr       = zeros(25600,10);
Adam_Predictions_StrI100_12_12_10000_lowlr  = zeros(25600,10);

StrI100_l2norm_12_12_10000_lowlr        = zeros(length(runs),1);
StrI100_Adam_l2norm_12_12_10000_lowlr   = zeros(length(runs),1);
    ...
    for j = 1:length(neurons)
        for k = 1:length(epochs)
            for l = 1:length(runs)
                ...
                Adam_Predictions_StrI100_12_12_10000_lowlr(:,l) = current_file / 10;
                StrI100_Adam_l2norm_12_12_10000_lowlr(l,1) = sqrt(sum((StrI100_enonlocal_true_vals - Adam_Predictions_StrI100_12_12_10000_lowlr(:,l)).^2 ./ StrI100_enonlocal_true_vals.^2));
                clear current_file
                ...
                Predictions_StrI100_12_12_10000_lowlr(:,l) = current_file / 10;
                StrI100_l2norm_12_12_10000_lowlr(l,1) = sqrt(sum((StrI100_enonlocal_true_vals - Predictions_StrI100_12_12_10000_lowlr(:,l)).^2 ./ StrI100_enonlocal_true_vals.^2));
                clear current_file
...
save Adam_Pred_L2norms_StrI100_12_12_10000_lowlr StrI100_Adam_l2norm_12_12_10000_lowlr
save LBFGS_Pred_L2norms_StrI100_12_12_10000_lowlr StrI100_l2norm_12_12_10000_lowlr
