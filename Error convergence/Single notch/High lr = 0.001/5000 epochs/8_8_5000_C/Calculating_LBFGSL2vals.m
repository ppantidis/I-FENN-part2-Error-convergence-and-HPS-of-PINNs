...
epochs  = [5000];   
runs    = 1:10;
Predictions_StrC100_8_8_5000_highlr       = zeros(10000,10);
Adam_Predictions_StrC100_8_8_5000_highlr  = zeros(10000,10);

StrC100_l2norm_8_8_5000_highlr        = zeros(length(runs),1);
StrC100_Adam_l2norm_8_8_5000_highlr   = zeros(length(runs),1);
    ...
    for j = 1:length(neurons)
        for k = 1:length(epochs)
            for l = 1:length(runs)
                ...
                Adam_Predictions_StrC100_8_8_5000_highlr(:,l) = current_file / 10;
                StrC100_Adam_l2norm_8_8_5000_highlr(l,1) = sqrt(sum((StrC100_enonlocal_true_vals - Adam_Predictions_StrC100_8_8_5000_highlr(:,l)).^2 ./ StrC100_enonlocal_true_vals.^2));
                clear current_file
                ...
                Predictions_StrC100_8_8_5000_highlr(:,l) = current_file / 10;
                StrC100_l2norm_8_8_5000_highlr(l,1) = sqrt(sum((StrC100_enonlocal_true_vals - Predictions_StrC100_8_8_5000_highlr(:,l)).^2 ./ StrC100_enonlocal_true_vals.^2));
                clear current_file
...
save Adam_Pred_L2norms_StrC100_8_8_5000_highlr StrC100_Adam_l2norm_8_8_5000_highlr
save LBFGS_Pred_L2norms_StrC100_8_8_5000_highlr StrC100_l2norm_8_8_5000_highlr
