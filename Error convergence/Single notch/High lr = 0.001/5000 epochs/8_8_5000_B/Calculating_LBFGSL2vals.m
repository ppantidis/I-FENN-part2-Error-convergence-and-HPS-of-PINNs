...
epochs  = [5000];   
runs    = 1:10;
Predictions_StrB100_8_8_5000_highlr       = zeros(6400,10);
Adam_Predictions_StrB100_8_8_5000_highlr  = zeros(6400,10);

StrB100_l2norm_8_8_5000_highlr        = zeros(length(runs),1);
StrB100_Adam_l2norm_8_8_5000_highlr   = zeros(length(runs),1);
    ...
    for j = 1:length(neurons)
        for k = 1:length(epochs)
            for l = 1:length(runs)
                ...
                Adam_Predictions_StrB100_8_8_5000_highlr(:,l) = current_file / 10;
                StrB100_Adam_l2norm_8_8_5000_highlr(l,1) = sqrt(sum((StrB100_enonlocal_true_vals - Adam_Predictions_StrB100_8_8_5000_highlr(:,l)).^2 ./ StrB100_enonlocal_true_vals.^2));
                clear current_file
                ...
                Predictions_StrB100_8_8_5000_highlr(:,l) = current_file / 10;
                StrB100_l2norm_8_8_5000_highlr(l,1) = sqrt(sum((StrB100_enonlocal_true_vals - Predictions_StrB100_8_8_5000_highlr(:,l)).^2 ./ StrB100_enonlocal_true_vals.^2));
                clear current_file
...
save Adam_Pred_L2norms_StrB100_8_8_5000_highlr StrB100_Adam_l2norm_8_8_5000_highlr
save LBFGS_Pred_L2norms_StrB100_8_8_5000_highlr StrB100_l2norm_8_8_5000_highlr
