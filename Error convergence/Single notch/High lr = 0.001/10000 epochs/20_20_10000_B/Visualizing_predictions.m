...
data_StrB100 = table2array(readtable('data_GP_StrB100_Nonlocal_gradient_Analytical_inc_164_init.csv'));
xcoord_vec = data_StrB100(:,1);
ycoord_vec = data_StrB100(:,2);
local_strain_vec = data_StrB100(:,11);
nonlocal_strain_vec_truth = data_StrB100(:,12);
clear data_StrB100

%%%%%%%%%%%%%%%%% Load data from Neural Network prediction %%%%%%%%%%%%%%%%
% Load and store the nonlocal strain prediction vector

J_Coarse_20_20_10000_M1 = load(strcat("Model11_TestE_StrB100_Predictions_20hidlay_20units_10000ep_inc_164_v1.txt"));
J_Coarse_20_20_10000_M2 = load(strcat("Model11_TestE_StrB100_Predictions_20hidlay_20units_10000ep_inc_164_v2.txt"));
J_Coarse_20_20_10000_M3 = load(strcat("Model11_TestE_StrB100_Predictions_20hidlay_20units_10000ep_inc_164_v3.txt"));
J_Coarse_20_20_10000_M4 = load(strcat("Model11_TestE_StrB100_Predictions_20hidlay_20units_10000ep_inc_164_v4.txt"));
J_Coarse_20_20_10000_M5 = load(strcat("Model11_TestE_StrB100_Predictions_20hidlay_20units_10000ep_inc_164_v5.txt"));
J_Coarse_20_20_10000_M6 = load(strcat("Model11_TestE_StrB100_Predictions_20hidlay_20units_10000ep_inc_164_v6.txt"));
J_Coarse_20_20_10000_M7 = load(strcat("Model11_TestE_StrB100_Predictions_20hidlay_20units_10000ep_inc_164_v7.txt"));
J_Coarse_20_20_10000_M8 = load(strcat("Model11_TestE_StrB100_Predictions_20hidlay_20units_10000ep_inc_164_v8.txt"));
J_Coarse_20_20_10000_M9 = load(strcat("Model11_TestE_StrB100_Predictions_20hidlay_20units_10000ep_inc_164_v9.txt"));
...
scatter(xcoord_vec,ycoord_vec,12,nonlocal_strain_vec_pred_M1,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet);caxis([0 caxismax]); box on;  % colorbar; 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,12,nonlocal_strain_vec_pred_M2,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 caxismax]); box on;  % colorbar;  

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,12,nonlocal_strain_vec_pred_M3,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 caxismax]); box on;  % colorbar; 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,12,nonlocal_strain_vec_pred_M4,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 caxismax]); box on; % colorbar; 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,12,nonlocal_strain_vec_pred_M5,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 caxismax]); box on; % colorbar; 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,12,nonlocal_strain_vec_pred_M6,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 caxismax]); box on;  % colorbar; 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]);
scatter(xcoord_vec,ycoord_vec,12,nonlocal_strain_vec_pred_M7,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 caxismax]); box on; % colorbar; 
...
% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,12,nonlocal_strain_vec_pred_M9,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 caxismax]); box on;  % colorbar; 
...
% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,12,RSE_M1,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 5e-3]); box on;  colormap(gca,viridis); 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,12,RSE_M2,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 5e-3]); box on;  colormap(gca,viridis); 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,12,RSE_M3,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 5e-3]); box on;  colormap(gca,viridis); 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,12,RSE_M4,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 5e-3]); box on; colormap(gca,viridis); 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,12,RSE_M5,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 5e-3]); box on; colormap(gca,viridis);  

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,12,RSE_M6,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 5e-3]); box on; colormap(gca,viridis); 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]);
scatter(xcoord_vec,ycoord_vec,12,RSE_M7,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 5e-3]); box on; colormap(gca,viridis); 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]);
scatter(xcoord_vec,ycoord_vec,12,RSE_M8,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 5e-3]); box on;  colormap(gca,viridis); 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,12,RSE_M9,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 5e-3]); box on;  colormap(gca,viridis); 
