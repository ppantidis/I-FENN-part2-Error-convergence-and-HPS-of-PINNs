...
data_StrI100 = table2array(readtable('data_GP_StrI100_Nonlocal_gradient_Analytical_inc_164_init.csv'));
xcoord_vec = data_StrI100(:,1);
ycoord_vec = data_StrI100(:,2);
local_strain_vec = data_StrI100(:,11);
nonlocal_strain_vec_truth = data_StrI100(:,12);
clear data_StrI100

%%%%%%%%%%%%%%%%% Load data from Neural Network prediction %%%%%%%%%%%%%%%%
% Load and store the nonlocal strain prediction vector

J_Coarse_8_8_10000_M1 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_12hidlay_12units_10000ep_inc_164_v1.txt"));
J_Coarse_8_8_10000_M2 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_12hidlay_12units_10000ep_inc_164_v2.txt"));
J_Coarse_8_8_10000_M3 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_12hidlay_12units_10000ep_inc_164_v3.txt"));
J_Coarse_8_8_10000_M4 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_12hidlay_12units_10000ep_inc_164_v4.txt"));
J_Coarse_8_8_10000_M5 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_12hidlay_12units_10000ep_inc_164_v5.txt"));
J_Coarse_8_8_10000_M6 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_12hidlay_12units_10000ep_inc_164_v6.txt"));
J_Coarse_8_8_10000_M7 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_12hidlay_12units_10000ep_inc_164_v7.txt"));
J_Coarse_8_8_10000_M8 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_12hidlay_12units_10000ep_inc_164_v8.txt"));
J_Coarse_8_8_10000_M9 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_12hidlay_12units_10000ep_inc_164_v9.txt"));

nonlocal_strain_vec_pred_M1 = J_Coarse_8_8_10000_M1 / 10;
nonlocal_strain_vec_pred_M2 = J_Coarse_8_8_10000_M2 / 10;
nonlocal_strain_vec_pred_M3 = J_Coarse_8_8_10000_M3 / 10;
nonlocal_strain_vec_pred_M4 = J_Coarse_8_8_10000_M4 / 10;
nonlocal_strain_vec_pred_M5 = J_Coarse_8_8_10000_M5 / 10;
nonlocal_strain_vec_pred_M6 = J_Coarse_8_8_10000_M6 / 10;
nonlocal_strain_vec_pred_M7 = J_Coarse_8_8_10000_M7 / 10;
nonlocal_strain_vec_pred_M8 = J_Coarse_8_8_10000_M8 / 10;
nonlocal_strain_vec_pred_M9 = J_Coarse_8_8_10000_M9 / 10;
...
title0 = title(t, '\bf{Non-local strain predictions (12x12 - 10000)}');
...
scatter(xcoord_vec,ycoord_vec,5,nonlocal_strain_vec_pred_M1,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet);caxis([0 caxismax]); box on;  % colorbar; 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,5,nonlocal_strain_vec_pred_M2,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 caxismax]); box on;  % colorbar;  

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,5,nonlocal_strain_vec_pred_M3,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 caxismax]); box on;  % colorbar; 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,5,nonlocal_strain_vec_pred_M4,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 caxismax]); box on; % colorbar; 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,5,nonlocal_strain_vec_pred_M5,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 caxismax]); box on; % colorbar; 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,5,nonlocal_strain_vec_pred_M6,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 caxismax]); box on;  % colorbar; 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]);
scatter(xcoord_vec,ycoord_vec,5,nonlocal_strain_vec_pred_M7,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 caxismax]); box on; % colorbar; 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]);
scatter(xcoord_vec,ycoord_vec,5,nonlocal_strain_vec_pred_M8,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 caxismax]); box on;  % colorbar; 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,5,nonlocal_strain_vec_pred_M9,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 caxismax]); box on;  % colorbar; 

print(f,'-dpdf', 'All_nonlocalstrain_predictions_Adam.pdf')
...
hold on;
t = tiledlayout(3,3,'TileSpacing','tight','Padding','compact');
title0 = title(t, '\bf{Non-local strain RSE (12x12 - 10000)}');
set(title0,'interpreter','latex','fontsize', 16,'Color','k');

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,5,RSE_M1,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 1e-2]); box on;  colormap(gca,viridis); 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,5,RSE_M2,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 1e-2]); box on;  colormap(gca,viridis); 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,5,RSE_M3,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 1e-2]); box on;  colormap(gca,viridis); 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,5,RSE_M4,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 1e-2]); box on; colormap(gca,viridis); 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,5,RSE_M5,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 1e-2]); box on; colormap(gca,viridis);  

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,5,RSE_M6,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 1e-2]); box on; colormap(gca,viridis); 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]);
scatter(xcoord_vec,ycoord_vec,5,RSE_M7,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 1e-2]); box on; colormap(gca,viridis); 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]);
scatter(xcoord_vec,ycoord_vec,5,RSE_M8,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 1e-2]); box on;  colormap(gca,viridis); 

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,5,RSE_M9,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 1e-2]); box on;  colormap(gca,viridis); 


print(f,'-dpdf', 'All_nonlocalstrain_RSE_Adam.pdf')
