...
J_Coarse_8_8_10000_M1 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_8hidlay_8units_10000ep_inc_164_v1.txt"));
J_Coarse_8_8_10000_M2 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_8hidlay_8units_10000ep_inc_164_v2.txt"));
J_Coarse_8_8_10000_M3 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_8hidlay_8units_10000ep_inc_164_v3.txt"));
J_Coarse_8_8_10000_M4 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_8hidlay_8units_10000ep_inc_164_v4.txt"));
J_Coarse_8_8_10000_M5 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_8hidlay_8units_10000ep_inc_164_v5.txt"));
J_Coarse_8_8_10000_M6 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_8hidlay_8units_10000ep_inc_164_v6.txt"));
J_Coarse_8_8_10000_M7 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_8hidlay_8units_10000ep_inc_164_v7.txt"));
J_Coarse_8_8_10000_M8 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_8hidlay_8units_10000ep_inc_164_v8.txt"));
J_Coarse_8_8_10000_M9 = load(strcat("Model11_TestE_StrI100_Adam_Predictions_8hidlay_8units_10000ep_inc_164_v9.txt"));
...
title0 = title(t, '\bf{Non-local strain predictions (8x8 - 10000)}');
...
hold on;
t = tiledlayout(3,3,'TileSpacing','tight','Padding','compact');
title0 = title(t, '\bf{Non-local strain RSE (8x8 - 10000)}');
set(title0,'interpreter','latex','fontsize', 16,'Color','k');

% Plot nonlocal equivalent strain contour prediction
nexttile; hold on; set(gca,'xtick',[],'ytick',[]); 
scatter(xcoord_vec,ycoord_vec,5,RSE_M1,'filled');
xlim(geom_xlimit); ylim(geom_ylimit); colormap(gca,jet); caxis([0 5e-2]); box on;  colormap(gca,viridis); 
